...
if __name__ == '__main__':
    ...
    # used for training single agent, similar setting for the following code
    ...
    # used for training multiple agent, now use two. , similar setting for the following code, you can change between these two setting
